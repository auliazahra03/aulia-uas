...
var format_titiklokasi_3 = new ol.format.GeoJSON();
var features_titiklokasi_3 = format_titiklokasi_3.readFeatures(json_titiklokasi_3, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_titiklokasi_3 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_titiklokasi_3.addFeatures(features_titiklokasi_3);
var lyr_titiklokasi_3 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_titiklokasi_3, 
                style: style_titiklokasi_3,
                popuplayertitle: 'titik lokasi',
                interactive: true,
                title: '<img src="styles/legend/titiklokasi_3.png" /> titik lokasi'
            });

lyr_GoogleHybrid_0.setVisible(true);lyr_ADMINISTRASIKECAMATAN_AR_50K_1.setVisible(true);lyr_polygon_2.setVisible(true);lyr_titiklokasi_3.setVisible(true);
var layersList = [lyr_GoogleHybrid_0,lyr_ADMINISTRASIKECAMATAN_AR_50K_1,lyr_polygon_2,lyr_titiklokasi_3];
...
lyr_titiklokasi_3.set('fieldAliases', {'id': 'id', 'kecamatan': 'kecamatan', 'kelurahan': 'kelurahan', });
...
lyr_titiklokasi_3.set('fieldImages', {'id': 'TextEdit', 'kecamatan': 'TextEdit', 'kelurahan': 'TextEdit', });
...
lyr_titiklokasi_3.set('fieldLabels', {'id': 'no label', 'kecamatan': 'no label', 'kelurahan': 'no label', });
lyr_titiklokasi_3.on('precompose', function(evt) {
